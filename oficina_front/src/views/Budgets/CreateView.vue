    ...
    <div class="px-4 ">
        <div class="container mx-auto">
            <div class="w-full ">
                ...
                <form @submit.prevent="storeBudget(form)"
                    ...
                    <div class="grid mt-3 md:grid-cols-2 md:gap-6">
                        ...
                        <div class="relative z-0 w-full mb-6 group">
                            ...
                            <CurrencyInput v-model="form.price" :options="{ currency: 'BRL'}"
                                           id="price"
                                           placeholder="R$"/>
                            <p v-if="errors.price"
                               class="mt-3 text-xs leading-3 text-red-600">
                    ...
                    <div class="grid md:grid-cols-1 md:gap-6">
                        <div class="relative z-0 w-full mb-6 group">
                            ...
                            <select v-model="form.seller_id"
                                    class="w-full p-2 mt-2 border border-gray-300 rounded outline-none focus:bg-gray-50">
                                <option disabled value="">Selecionar Vendedor</option>
                                <option v-for="({id, name}, i) in sellers" :value="id">{{name}}</option>
                            </select>
...
const {storeBudget, errors} = useBudget();
const {getAllSellers, sellers} = useSeller();
